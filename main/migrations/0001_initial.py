# Generated by Django 4.1.3 on 2024-05-11 12:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('MEN', 'Men'), ('WOMEN', 'Women'), ('NONBINARY', 'Nonbinary')], max_length=255)),
                ('age', models.PositiveSmallIntegerField(blank=True, null=True)),
                ('language', models.CharField(choices=[('ENGLISH', 'English'), ('INDONESIA', 'Indonesia')], max_length=255)),
